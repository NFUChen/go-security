...
func (service *UserService) GetAllRoles(ctx context.Context) ([]*UserRole, error) {
	return service.UserRepository.FindAllRoles(ctx)
}

func (service *UserService) GetRoleByName(ctx context.Context, name string) (*UserRole, error) {
	if len(name) == 0 {
		return nil, security.UserRoleNotAllowed
	}
	return service.UserRepository.FindRoleByName(ctx, name)
}
func (service *UserService) GetPlatformByName(ctx context.Context, name PlatformType) (*Platform, error) {
	if len(name) == 0 {
...
func (service *UserService) GetUserByID(ctx context.Context, id uint) (*User, error) {
...
func (service *UserService) GetUserByUserName(ctx context.Context, name string) (*User, error) {
